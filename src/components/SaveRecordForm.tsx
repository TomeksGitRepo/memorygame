...
export default class SaveRecordForm extends React.Component<any, any> {
  ...
  handleSubmit(event: any) {
    ...
    if (this.state.value === 'Twój nick' || this.state.value === '') {
      return;
    }
      ...
      return (
        <div className="ui container">
          <h1 className="ui center aligned header">
            Gratulujemy uzyskania tak dobrego wyniku
          </h1>
          <h5 className="ui center aligned header">
            Zapisz swój wynik podając swój nick
          </h5>
          <form className="ui form" onSubmit={this.handleSubmit}>
            ...
            <input className="fluid ui button" type="submit" value="Wyślij" />
          </form>
        </div>
      );
    } else {
